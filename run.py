...
parser.add_argument("--sd_path", default='CompVis/stable-diffusion-v1-4', type=str, help="Path to Stable Diffusion Folder")
parser.add_argument("--vae_path", default='/home/softbuilders/Desktop/AutoStudio/1.5/vae/vae', type=str, help="Path to VAE Folder")
...
if args.sd_version == '1.5':
    ip_ckpt = "/home/softbuilders/Desktop/AutoStudio/1.5/adapter/ip-adapter_sd15.bin"
    image_encoder_path = "/home/softbuilders/Desktop/AutoStudio/1.5/image_encoder"
    ...
    '''
    unet = UNet2DConditionModel.from_pretrained('/home/softbuilders/Desktop/AutoStudio/1.5/unet/unet').to(dtype=torch.float16) 
